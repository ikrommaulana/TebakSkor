...
$potong=substr($nama, 0, 4);
$nama_asli=substr($nama, 4);

if ($potong == "VIP ")
{
	if ($n % 2 == 0)
	  {
		echo "<tr><td>$id_users</td><td>$nama_asli</td><td>$email</td><td>$mobile</td><td>$phone</td><td>$address</td><td>$status</td><td>$propinsi</td><td>$kota</td><td>$kecamatan</td><td>$kelurahan</td><td>$rw</td><td>$joined_date</td></tr>";

	  }
	else
	  {
		echo "<tr class='even'><td>$id_users</td><td>$nama_asli</td><td>$email</td><td>$mobile</td><td>$phone</td><td>$address</td><td>$status</td><td>$propinsi</td><td>$kota</td><td>$kecamatan</td><td>$kelurahan</td><td>$rw</td><td>$joined_date</td></tr>";
	  }
