            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="col-md-6">
                            <?php echo form_open_multipart('root/career/save'); ?>
                        ...
                        <div class="col-md-6">
								...
								<div class="form-group">
                                    ...
                                    <input type="text" name="edu" class="form-control" placeholder="Latest Education">
                                </div>
								
                                <div class="form-group">
                                    <label>Years Experience</label>
                                    <input type="text" name="exp" class="form-control" placeholder="Years Experience">
                                </div>
                                <div class="form-group">
                                    <label>Status</label>
