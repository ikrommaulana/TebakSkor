                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <table data-toggle="table" data-url="<?php base_url();?>assets/tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
                            ...
                            <form role="form" method="get" action="root/customer/search">    
                            <?php echo form_open('root/customer/search'); ?>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <input type="text" name="from" class="tgl form-control" placeholder="From"/>
                                    </div>
                            </div>
                            <div class="col-md-2">
                                    <input type="text" name="until" class="tgl form-control" placeholder="Until"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <tr>
                                ...
                                <td><?= $cust->district_name; ?></td>
                                <td><?= $cust->subdistrict_name; ?></td>
                                <td><?= $cust->status; ?></td>
                            </tr>
                                <?php } ?>
                            </tbody>
