...
/**if(isset($_GET['dari'])){
		...
		$ambil = mysql_query("SELECT * FROM survey_customer ORDER BY id DESC ");
...
$ambil = mysql_query("SELECT * FROM survey_customer ORDER BY id ");
...
/* echo $n; */
	...
	if ($n % 2 == 0)
  {
    echo "<tr><td>$id</td><td>$date</td><td>$id_cust</td><td>$nama</td><td>$email</td><td>$layanan</td><td>$q1</td><td>$q1_detail</td><td>$q2</td><td>$q2_detail</td><td>$q3</td><td>$q3_detail</td><td>$q4</td><td>$q4_detail</td><td>$q5</td><td>$q6_a</td><td>$q6_b</td><td>$q6_c</td><td>$q6_d</td><td>$q7</td><td>$q8</td><td>$q8_detail</td><td>$q9</td><td>$q9_detail</td><td>$q10</td><td>$q10_detail</td><td>$q11</td><td>$q11_detail</td><td>$q12</td><td>$q12_detail</td><td>$q13</td><td>$q13_detail</td><td>$q14</td><td>$q15</td><td>$q16</td><td>$q16_detail</td><td>$q17</td><td>$q18</td><td>$q18_detail</td></tr>";
